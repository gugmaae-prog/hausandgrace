...
export type Insight = {
  slug: string;
  category: "Market research" | "Video briefing" | "Investor guide" | "Community intelligence" | "New launches" | "Developer analysis";
  title: string;
  dek: string;
  readTime: string;
  image: string;
...
function projectImage(slug: string) { return getProjectRecord(slug)?.image || ""; }
...
export const insights: Insight[] = [
  ...
  },
  {
    ...
    readTime: "13 min",
    image: projectImage("emaar-marina-shores-at-dubai-marina-apartments-for-sale"),
    published: "23 July 2026",
  ...
  },
  {
    ...
    readTime: "8 min",
    image: projectImage("greencrest-dubai-hills-estate-emaar"),
  ...
  },
  {
    ...
    image: projectImage("maison-margiela-residences-palm-jumeirah-dubai"),
  ...
  },
  {
    ...
    readTime: "8 min",
    image: projectImage("wyndham-residences-al-marjan-island-rak-uae"),
  ...
  },
  {
    ...
    readTime: "9 min",
    image: projectImage("arancia-yards-2-beyond-city-of-arabia-dubai"),
  ...
  },
  {
    ...
    readTime: "8 min",
    image: projectImage("chelsea-residences-damac-properties-dubai-maritime-city"),
