...
export const metadata = pageMetadata("List Your Property", "Sell or lease your UAE property with valuation, premium media, portal distribution, qualified demand and accountable reporting from HAUS & GRACE.", "/list-your-property");
...
const marketingServices = [
  ...
  ["04", "Qualified distribution", "HAUS & GRACE channels, major UAE portals, private buyer and tenant networks, agent-to-agent circulation and direct database matching."],
...
export default function ListPropertyPage() {
  return <main>
    <InternalHeader />
    <section className="list-hero"><div><p className="kicker light">List your unit with HAUS &amp; GRACE</p><h1>A complete route<br /><em>from asset to outcome.</em></h1><p>Valuation, premium presentation, qualified distribution, campaign management and negotiation—run as one accountable owner strategy.</p><a href="#owner-appraisal">Request a private appraisal</a></div><img src={propertyImages.interior} alt="Premium UAE residence prepared for property marketing" /></section>
